...
public class SettingsXmlParser {
    public static final String TAG = SettingsXmlParser.class.getSimpleName();
                ...
                switch (eventType) {
                    ...
                    case XmlPullParser.END_TAG:
                        if ("setting".equals(xmlResParser.getName())) {
                            ...
                            Log.d(TAG, String.format("parse new setting --->%s", JSON.toJSONString(readSetting)));
                            readSetting = null;
                        }

                        if ("setting-array".equals(xmlResParser.getName())) {
                            settingArray.add(readSettingArray);
                            Log.d(TAG, String.format("parse new settingArray --->%s", JSON.toJSONString(readSettingArray)));
                        ...
                        if ("extra".equals(xmlResParser.getName())) {
                            ...
                            Log.d(TAG, String.format("parse new settingExtra --->%s", JSON.toJSONString(settingExtras)));
